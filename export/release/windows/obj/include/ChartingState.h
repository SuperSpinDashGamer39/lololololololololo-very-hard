...
class HXCPP_CLASS_ATTRIBUTES ChartingState_obj : public  ::MusicBeatState_obj
{
	...
	public:
		...
		Float timeOld;
		 ...
		 ::flixel::addons::ui::FlxUIDropDownMenu player1DropDown;
		 ::flixel::addons::ui::FlxUIDropDownMenu player2DropDown;
		 ::flixel::addons::ui::FlxUIDropDownMenu gfDropDown;
		 ::flixel::addons::ui::FlxUIDropDownMenu stageDropDown;
		::Array< ::String > diffList;
		::String diffDropFinal;
		 ::flixel::addons::ui::FlxUICheckBox bfClick;
		 ::flixel::addons::ui::FlxUICheckBox opClick;
		 ::flixel::addons::ui::FlxUINumericStepper gotoSectionStepper;
		 ::flixel::FlxSprite strumLine;
		::String curSong;
		int amountSteps;
		 ::flixel::group::FlxTypedGroup bullshitUI;
		::Array< int > strumColors;
		...
		bool holding;
		 ...
		 ::flixel::FlxSprite gridBG2;
		 ::flixel::FlxSprite gridBGTriple;
		 ::flixel::FlxSprite gridBGOverlay;
		 ::Dynamic _song;
		...
		Float tempBpm;
		 ...
		 ::flixel::FlxSprite leftIconBack;
		 ::flixel::FlxSprite rightIconBack;
		bool justChanged;
		void create();
		...
		void setNoteSustain(Float value);
		::Dynamic setNoteSustain_dyn();
		...
		void addNotesToRender(int curSec, ::Dynamic secOffset);
		::Dynamic addNotesToRender_dyn();
		...
		void clearSectionBF();
		::Dynamic clearSectionBF_dyn();

		void clearSectionOpp();
		::Dynamic clearSectionOpp_dyn();

		void clearSong();
		::Dynamic clearSong_dyn();

		void addNote(Float _noteStrum,int _noteData, ::Dynamic skipSectionCheck);
		::Dynamic addNote_dyn();
		...
		void saveGenericLevel();
		::Dynamic saveGenericLevel_dyn();
		...
		void swapSections();
		::Dynamic swapSections_dyn();

		bool sectionHasBfNotes(int section);
		::Dynamic sectionHasBfNotes_dyn();

		void removeDuplicates(int section,::cpp::VirtualArray forceNote);
		::Dynamic removeDuplicates_dyn();

		bool approxEqual( ::Dynamic x, ::Dynamic y,Float tolerance);
		::Dynamic approxEqual_dyn();
