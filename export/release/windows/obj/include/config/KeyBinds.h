...
#define INCLUDED_config_KeyBinds

#ifndef HXCPP_H
#include <hxcpp.h>
#endif

HX_DECLARE_CLASS1(config,KeyBinds)
...
class HXCPP_CLASS_ATTRIBUTES KeyBinds_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x7e17e1b5 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=false,const char *inName="config.KeyBinds")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,false,"config.KeyBinds"); }
		...
		inline static ::hx::ObjectPtr< KeyBinds_obj > __alloc(::hx::Ctx *_hx_ctx) {
			KeyBinds_obj *__this = (KeyBinds_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(KeyBinds_obj), false, "config.KeyBinds"));
...
#endif /* INCLUDED_config_KeyBinds */ 
