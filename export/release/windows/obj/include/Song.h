...
HX_DECLARE_STACK_FRAME(_hx_pos_4e288e2989890fc6_25_new)
...
HXLINE(  36)		( ( ::Song)(__this) )->gf = HX_("gf",1f,5a,00,00);
HXLINE(  35)		( ( ::Song)(__this) )->stage = HX_("",00,00,00,00);
HXLINE(  34)		( ( ::Song)(__this) )->player2 = HX_("dad",47,36,4c,00);
HXLINE(  33)		( ( ::Song)(__this) )->player1 = HX_("bf",c4,55,00,00);
HXLINE(  31)		( ( ::Song)(__this) )->speed = ((Float)1);
HXLINE(  30)		( ( ::Song)(__this) )->needsVoices = true;
HXLINE(  40)		( ( ::Song)(__this) )->song = song;
HXLINE(  41)		( ( ::Song)(__this) )->notes = notes;
HXLINE(  42)		( ( ::Song)(__this) )->bpm = bpm;
            	}
