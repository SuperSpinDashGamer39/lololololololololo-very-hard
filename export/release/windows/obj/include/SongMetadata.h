...
HX_DECLARE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_283_new)
...
{
            	HX_STACKFRAME(&_hx_pos_66f21fcacf595f6d_283_new)
HXLINE( 287)		( ( ::SongMetadata)(__this) )->songCharacter = HX_("",00,00,00,00);
HXLINE( 286)		( ( ::SongMetadata)(__this) )->week = 0;
HXLINE( 285)		( ( ::SongMetadata)(__this) )->songName = HX_("",00,00,00,00);
HXLINE( 291)		( ( ::SongMetadata)(__this) )->songName = song;
HXLINE( 292)		( ( ::SongMetadata)(__this) )->week = week;
HXLINE( 293)		( ( ::SongMetadata)(__this) )->songCharacter = songCharacter;
            	}
