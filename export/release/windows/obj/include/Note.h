...
class HXCPP_CLASS_ATTRIBUTES Note_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		void __construct(Float _strumTime,int _noteData, ::Dynamic __o__editor, ::Note _prevNote, ::Dynamic __o__sustainNote);
		...
		static ::hx::ObjectPtr< Note_obj > __new(Float _strumTime,int _noteData, ::Dynamic __o__editor, ::Note _prevNote, ::Dynamic __o__sustainNote);
		static ::hx::ObjectPtr< Note_obj > __alloc(::hx::Ctx *_hx_ctx,Float _strumTime,int _noteData, ::Dynamic __o__editor, ::Note _prevNote, ::Dynamic __o__sustainNote);
