...
class HXCPP_CLASS_ATTRIBUTES HealthIcon_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		void __construct(::String __o__hx_char,::hx::Null< bool >  __o_isPlayer, ::Dynamic __o__id);
		...
		static ::hx::ObjectPtr< HealthIcon_obj > __new(::String __o__hx_char,::hx::Null< bool >  __o_isPlayer, ::Dynamic __o__id);
		static ::hx::ObjectPtr< HealthIcon_obj > __alloc(::hx::Ctx *_hx_ctx,::String __o__hx_char,::hx::Null< bool >  __o_isPlayer, ::Dynamic __o__id);
		...
		static void __boot();
		static ::Array< ::String > pixelIcons;
		 ::flixel::FlxSprite sprTracker;
		int id;
		Float defualtIconScale;
		Float iconScale;
		Float iconSize;
		 ::flixel::tweens::FlxTween tween;
		void update(Float elapsed);

		void tweenToDefaultScale(Float _time, ::Dynamic _ease);
		::Dynamic tweenToDefaultScale_dyn();
