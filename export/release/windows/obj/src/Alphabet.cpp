...
HXDLIN( 207)					_hx_tmp->play((((HX_("assets/sounds/",1f,fa,fb,94) + (daSound + ::flixel::FlxG_obj::random->_hx_int(1,4,null()))) + HX_(".",2e,00,00,00)) + ::Paths_obj::audioExtension),((Float)0.4),null(),null(),null(),null());
            				}
