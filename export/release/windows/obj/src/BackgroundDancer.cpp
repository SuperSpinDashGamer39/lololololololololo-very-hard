...
HXLINE(  12)		::String data = ((HX_("assets/images/",ab,47,cb,9f) + HX_("limo/limoDancer",8e,b6,e5,ea)) + HX_(".png",3b,2d,bd,1e));
HXDLIN(  12)		 ::Dynamic _hx_tmp;
HXDLIN(  12)		if (::ImageCache_obj::exists(data)) {
HXLINE(  12)			_hx_tmp = ::ImageCache_obj::get(data);
            		}
            		else {
HXLINE(  12)			_hx_tmp = data;
            		}
HXDLIN(  12)		this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,((HX_("assets/images/",ab,47,cb,9f) + HX_("limo/limoDancer",8e,b6,e5,ea)) + HX_(".xml",69,3e,c3,1e))));
