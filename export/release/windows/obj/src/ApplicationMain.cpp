...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("FunkinFPSPlus",92,9d,63,51),::ApplicationMain_obj::create_dyn());
...
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("Rozebud",69,2c,6d,35));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("FunkinFPSPlus",92,9d,63,51));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Friday Night Funkin' FPS Plus",44,36,d2,cf));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.example.myapp",84,30,57,c1));
HXLINE(  40)		app->meta->set(HX_("version",18,e7,f1,7c),HX_("FNF: v0.2.7 | FPS Plus: v3.7",56,da,d5,9d));
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Friday Night Funkin' FPS Plus",44,36,d2,cf))
