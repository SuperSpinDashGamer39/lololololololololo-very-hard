...
HXLINE( 248)		::String data = ((HX_("assets/images/",ab,47,cb,9f) + HX_("alphabet",b3,7c,38,21)) + HX_(".png",3b,2d,bd,1e));
HXDLIN( 248)		 ::Dynamic tex;
HXDLIN( 248)		if (::ImageCache_obj::exists(data)) {
HXLINE( 248)			tex = ::ImageCache_obj::get(data);
            		}
            		else {
HXLINE( 248)			tex = data;
            		}
HXDLIN( 248)		 ::flixel::graphics::frames::FlxAtlasFrames tex1 = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(tex,((HX_("assets/images/",ab,47,cb,9f) + HX_("alphabet",b3,7c,38,21)) + HX_(".xml",69,3e,c3,1e)));
