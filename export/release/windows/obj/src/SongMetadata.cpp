...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_283_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",283,0x0d86f62d)
...
HXLINE( 287)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 286)		this->week = 0;
HXLINE( 285)		this->songName = HX_("",00,00,00,00);
HXLINE( 291)		this->songName = song;
HXLINE( 292)		this->week = week;
HXLINE( 293)		this->songCharacter = songCharacter;
            	}
