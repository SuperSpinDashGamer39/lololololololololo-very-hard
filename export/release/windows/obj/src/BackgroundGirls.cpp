...
HXLINE(  13)		::String data = ((HX_("assets/images/",ab,47,cb,9f) + HX_("weeb/bgFreaks",d9,71,bd,0f)) + HX_(".png",3b,2d,bd,1e));
HXDLIN(  13)		 ::Dynamic _hx_tmp;
HXDLIN(  13)		if (::ImageCache_obj::exists(data)) {
HXLINE(  13)			_hx_tmp = ::ImageCache_obj::get(data);
            		}
            		else {
HXLINE(  13)			_hx_tmp = data;
            		}
HXDLIN(  13)		this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,((HX_("assets/images/",ab,47,cb,9f) + HX_("weeb/bgFreaks",d9,71,bd,0f)) + HX_(".xml",69,3e,c3,1e))));
