...
HX_LOCAL_STACK_FRAME(_hx_pos_cbc83c06c393c08a_85_menuControls,"PlayerSettings","menuControls",0x3584285f,"PlayerSettings.menuControls","PlayerSettings.hx",85,0x01b08bba)
HX_LOCAL_STACK_FRAME(_hx_pos_cbc83c06c393c08a_99_gameControls,"PlayerSettings","gameControls",0xb82ce1b2,"PlayerSettings.gameControls","PlayerSettings.hx",99,0x01b08bba)
HX_LOCAL_STACK_FRAME(_hx_pos_cbc83c06c393c08a_114_reset,"PlayerSettings","reset",0x3db45f65,"PlayerSettings.reset","PlayerSettings.hx",114,0x01b08bba)
...
HXLINE(  65)		::PlayerSettings_obj::menuControls();
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC0(PlayerSettings_obj,init,(void))

void PlayerSettings_obj::menuControls(){
            	HX_STACKFRAME(&_hx_pos_cbc83c06c393c08a_85_menuControls)
HXLINE(  87)		int numGamepads = ::flixel::FlxG_obj::gamepads->get_numActiveGamepads();
HXLINE(  88)		if ((numGamepads > 0)) {
HXLINE(  90)			 ::flixel::input::gamepad::FlxGamepad gamepad = ::flixel::FlxG_obj::gamepads->_activeGamepads->__get(0).StaticCast<  ::flixel::input::gamepad::FlxGamepad >();
HXLINE(  91)			if (::hx::IsNull( gamepad )) {
HXLINE(  92)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Unexpected null gamepad. id:0",5a,05,91,b2)));
            			}
HXLINE(  94)			::PlayerSettings_obj::player1->controls->setMenuControls(0);
            		}
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC0(PlayerSettings_obj,menuControls,(void))

void PlayerSettings_obj::gameControls(){
            	HX_STACKFRAME(&_hx_pos_cbc83c06c393c08a_99_gameControls)
HXLINE( 101)		int numGamepads = ::flixel::FlxG_obj::gamepads->get_numActiveGamepads();
HXLINE( 102)		if ((numGamepads > 0)) {
HXLINE( 104)			 ::flixel::input::gamepad::FlxGamepad gamepad = ::flixel::FlxG_obj::gamepads->_activeGamepads->__get(0).StaticCast<  ::flixel::input::gamepad::FlxGamepad >();
HXLINE( 105)			if (::hx::IsNull( gamepad )) {
HXLINE( 106)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Unexpected null gamepad. id:0",5a,05,91,b2)));
            			}
HXLINE( 108)			::PlayerSettings_obj::player1->controls->setGameControls(0);
            		}
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC0(PlayerSettings_obj,gameControls,(void))

void PlayerSettings_obj::reset(){
            	HX_STACKFRAME(&_hx_pos_cbc83c06c393c08a_114_reset)
HXLINE( 115)		::PlayerSettings_obj::player1 = null();
HXLINE( 116)		::PlayerSettings_obj::player2 = null();
HXLINE( 117)		::PlayerSettings_obj::numPlayers = 0;
            	}
...
bool PlayerSettings_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"menuControls") ) { outValue = menuControls_dyn(); return true; }
		if (HX_FIELD_EQ(inName,"gameControls") ) { outValue = gameControls_dyn(); return true; }
		break;
	case 14:
