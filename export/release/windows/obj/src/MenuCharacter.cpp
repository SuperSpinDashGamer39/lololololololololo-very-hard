...
HXLINE(  16)		::String data = ((HX_("assets/images/",ab,47,cb,9f) + HX_("campaign_menu_UI_characters",24,49,1a,60)) + HX_(".png",3b,2d,bd,1e));
HXDLIN(  16)		 ::Dynamic tex;
HXDLIN(  16)		if (::ImageCache_obj::exists(data)) {
HXLINE(  16)			tex = ::ImageCache_obj::get(data);
            		}
            		else {
HXLINE(  16)			tex = data;
            		}
HXDLIN(  16)		 ::flixel::graphics::frames::FlxAtlasFrames tex1 = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(tex,((HX_("assets/images/",ab,47,cb,9f) + HX_("campaign_menu_UI_characters",24,49,1a,60)) + HX_(".xml",69,3e,c3,1e)));
