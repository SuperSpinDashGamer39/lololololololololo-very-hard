...
HX_DEFINE_STACK_FRAME(_hx_pos_4e288e2989890fc6_25_new,"Song","new",0xfb6c8f67,"Song.new","Song.hx",25,0x775e99e9)
...
void Song_obj::__construct(::String song,::Array< ::Dynamic> notes,Float bpm){
            	HX_STACKFRAME(&_hx_pos_4e288e2989890fc6_25_new)
HXLINE(  36)		this->gf = HX_("gf",1f,5a,00,00);
HXLINE(  35)		this->stage = HX_("",00,00,00,00);
...
HXLINE(  40)		this->song = song;
HXLINE(  41)		this->notes = notes;
HXLINE(  42)		this->bpm = bpm;
            	}
...
HXLINE(  47)		::String rawJson = ((HX_("assets/data/",f9,10,73,a0) + folder.toLowerCase()) + HX_("/",2f,00,00,00));
HXDLIN(  47)		::String rawJson1 = ::StringTools_obj::trim(::lime::utils::Assets_obj::getText(((rawJson + jsonInput.toLowerCase()) + HX_(".json",56,f1,d6,c2))));
HXLINE(  49)		while(!(::StringTools_obj::endsWith(rawJson1,HX_("}",7d,00,00,00)))){
HXLINE(  51)			rawJson1 = rawJson1.substr(0,(rawJson1.length - 1));
            		}
HXLINE(  71)		return ::Song_obj::parseJSONshit(rawJson1);
            	}
...
::hx::Val Song_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 2:
		if (HX_FIELD_EQ(inName,"gf") ) { gf=inValue.Cast< ::String >(); return inValue; }
		break;
	case 3:
...
static ::hx::StorageInfo Song_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsString,(int)offsetof(Song_obj,gf),HX_("gf",1f,5a,00,00)},
	{ ::hx::fsUnknown, 0, null()}
};
