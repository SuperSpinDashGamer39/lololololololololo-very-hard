...
HXLINE(  53)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_funkin_bold_otf >());
HXLINE(  54)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_funkin_otf >());
...
HXLINE(  62)		 ::Dynamic bundle;
HXDLIN(  62)		::String data = HX_("{\"name\":null,\"assets\":\"ah\",\"rootPath\":null,\"version\":2,\"libraryArgs\":[],\"libraryType\":null}",6c,e1,75,d6);
HXDLIN(  62)		 ::lime::utils::AssetManifest manifest = ::lime::utils::AssetManifest_obj::parse(data,::ManifestResources_obj::rootPath);
HXDLIN(  62)		 ::lime::utils::AssetLibrary library = ::lime::utils::AssetLibrary_obj::fromManifest(manifest);
HXLINE(  78)		::lime::utils::Assets_obj::registerLibrary(HX_("data",2a,56,63,42),library);
HXLINE(  79)		data = HX_("{\"name\":null,\"assets\":\"ah\",\"rootPath\":null,\"version\":2,\"libraryArgs\":[],\"libraryType\":null}",6c,e1,75,d6);
HXLINE(  80)		manifest = ::lime::utils::AssetManifest_obj::parse(data,::ManifestResources_obj::rootPath);
HXLINE(  81)		library = ::lime::utils::AssetLibrary_obj::fromManifest(manifest);
HXLINE(  82)		::lime::utils::Assets_obj::registerLibrary(HX_("sounds",c4,a8,2e,32),library);
HXLINE(  83)		data = HX_("{\"name\":null,\"assets\":\"ah\",\"rootPath\":null,\"version\":2,\"libraryArgs\":[],\"libraryType\":null}",6c,e1,75,d6);
HXLINE(  84)		manifest = ::lime::utils::AssetManifest_obj::parse(data,::ManifestResources_obj::rootPath);
HXLINE(  85)		library = ::lime::utils::AssetLibrary_obj::fromManifest(manifest);
HXLINE(  86)		::lime::utils::Assets_obj::registerLibrary(HX_("music",a5,d0,5a,10),library);
HXLINE(  87)		data = HX_("{\"name\":null,\"assets\":\"ah\",\"rootPath\":null,\"version\":2,\"libraryArgs\":[],\"libraryType\":null}",6c,e1,75,d6);
HXLINE(  88)		manifest = ::lime::utils::AssetManifest_obj::parse(data,::ManifestResources_obj::rootPath);
HXLINE(  89)		library = ::lime::utils::AssetLibrary_obj::fromManifest(manifest);
HXLINE(  90)		::lime::utils::Assets_obj::registerLibrary(HX_("images",b8,50,92,fe),library);
HXLINE(  91)		data = HX_("{\"name\":null,\"assets\":\"ah\",\"rootPath\":null,\"version\":2,\"libraryArgs\":[],\"libraryType\":null}",6c,e1,75,d6);
HXLINE(  92)		manifest = ::lime::utils::AssetManifest_obj::parse(data,::ManifestResources_obj::rootPath);
HXLINE(  93)		library = ::lime::utils::AssetLibrary_obj::fromManifest(manifest);
HXLINE(  94)		::lime::utils::Assets_obj::registerLibrary(HX_("videos",98,d7,95,e5),library);
HXLINE(  95)		{
HXLINE(  95)			::String v = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  95)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v);
            		}
HXLINE(  98)		library = ::lime::utils::Assets_obj::getLibrary(HX_("data",2a,56,63,42));
HXLINE(  99)		if (::hx::IsNotNull( library )) {
HXLINE(  99)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 100)			::ManifestResources_obj::preloadLibraryNames->push(HX_("data",2a,56,63,42));
            		}
HXLINE( 101)		library = ::lime::utils::Assets_obj::getLibrary(HX_("sounds",c4,a8,2e,32));
HXLINE( 102)		if (::hx::IsNotNull( library )) {
HXLINE( 102)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 103)			::ManifestResources_obj::preloadLibraryNames->push(HX_("sounds",c4,a8,2e,32));
            		}
HXLINE( 104)		library = ::lime::utils::Assets_obj::getLibrary(HX_("music",a5,d0,5a,10));
HXLINE( 105)		if (::hx::IsNotNull( library )) {
HXLINE( 105)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 106)			::ManifestResources_obj::preloadLibraryNames->push(HX_("music",a5,d0,5a,10));
            		}
HXLINE( 107)		library = ::lime::utils::Assets_obj::getLibrary(HX_("images",b8,50,92,fe));
HXLINE( 108)		if (::hx::IsNotNull( library )) {
HXLINE( 108)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 109)			::ManifestResources_obj::preloadLibraryNames->push(HX_("images",b8,50,92,fe));
            		}
HXLINE( 110)		library = ::lime::utils::Assets_obj::getLibrary(HX_("videos",98,d7,95,e5));
HXLINE( 111)		if (::hx::IsNotNull( library )) {
HXLINE( 111)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 112)			::ManifestResources_obj::preloadLibraryNames->push(HX_("videos",98,d7,95,e5));
            		}
