...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("FunkinFPSPlus", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("FunkinFPSPlus", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "25";
		app.meta["company"] = "Rozebud";
		app.meta["file"] = "FunkinFPSPlus";
		app.meta["name"] = "Friday Night Funkin' FPS Plus";
		app.meta["packageName"] = "com.example.myapp";
		app.meta["version"] = "FNF: v0.2.7 | FPS Plus: v3.7";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin' FPS Plus",
			width: 1280,
			x: null,
			y: null,
		};
